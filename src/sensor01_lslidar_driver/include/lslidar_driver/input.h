...
#include <sensor02_lslidar_msgs/msg/lslidar_packet.hpp>
#include <string>
#include <sstream>
...
public:
  ...
  virtual int getPacket(sensor02_lslidar_msgs::msg::LslidarPacket::UniquePtr &packet) = 0;
...
public:
  ...
  virtual int getPacket(sensor02_lslidar_msgs::msg::LslidarPacket::UniquePtr &packet);
...
public:
    InputPCAP(rclcpp::Node* private_nh,uint16_t port = MSOP_DATA_PORT_NUMBER, double packet_rate = 0.0,
            std::string filename="");
    virtual ~InputPCAP();
    virtual int getPacket(sensor02_lslidar_msgs::msg::LslidarPacket::UniquePtr &pkt);
private:

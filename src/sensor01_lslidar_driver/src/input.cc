...
namespace lslidar_driver
{
    ...
    int InputSocket::getPacket(sensor02_lslidar_msgs::msg::LslidarPacket::UniquePtr &packet)
    {
        int q = 0;
        struct pollfd fds[1];
        fds[0].fd = sockfd_;
    ...
    int InputPCAP::getPacket(sensor02_lslidar_msgs::msg::LslidarPacket::UniquePtr &pkt)
    {
